...
public class DataIndexApiImpl implements DataIndexApi {
    ...
    public static final String GET_PROCESS_INSTANCE_AVAILABLE_NODES_URI = "/management/processes/%s/nodes";
    ...
    @Override
    public CompletableFuture<List<Node>> getProcessInstanceAvailableNodes(String serviceURL, ProcessInstance processInstance) {
        String requestURI = format(GET_PROCESS_INSTANCE_AVAILABLE_NODES_URI, processInstance.getProcessId());
