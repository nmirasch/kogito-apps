...
import static org.kie.kogito.index.api.DataIndexApiImpl.GET_PROCESS_INSTANCE_AVAILABLE_NODES_URI;
...
public class RuntimeServiceWiremock implements QuarkusTestResourceLifecycleManager {
    ...
    public final static String jsonNodeInstanceListString =
            "[{" +
                    ...
                    "\"results\":{}" +
                    "}]";
    public final static String jsonAvailableNodesListString = "[\n" +
            "  {\n" +
    ...
    public Map<String, String> start() {
        ...
        stubFor(get(urlEqualTo(format(GET_PROCESS_INSTANCE_NODES_URI, PROCESS_ID, PROCESS_INSTANCE_ID_FAIL)))
                .willReturn(notFound()));
        stubFor(get(urlEqualTo(format(GET_PROCESS_INSTANCE_AVAILABLE_NODES_URI, PROCESS_ID)))
                .willReturn(okJson(jsonAvailableNodesListString)));

        stubFor(get(urlEqualTo(format(GET_PROCESS_INSTANCE_AVAILABLE_NODES_URI, PROCESS_ID_FAIL)))
                .willReturn(notFound()));
